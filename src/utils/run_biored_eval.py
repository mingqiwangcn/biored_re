...
def dump_pred_2_pubtator_file(in_gold_pubtator_file,
                              in_gold_tsv_file,
    ...
    with open(in_gold_pubtator_file, 'r', encoding='utf8') as pub_reader:
...
def run_test_eval(
    ...
    dump_pred_2_pubtator_file(in_gold_pubtator_file    = in_gold_pubtator_file,
...
if __name__ == '__main__':
    ...
    if exp_option == 'biored_eval':
        ...
        in_gold_tsv_file          = 'datasets/biored/processed/test.tsv'
